        ...
        <div class="bg-mono flex scrollbar-custom">
            ...
            <main class="w-full h-[100%] px-[20px] py-[20px] bg-transparent">
                ...
                <div class="options flex gap-1 items-center text-[14px] mt-4">
                    ...
                    <span class="material-symbols-rounded text-[18px]">chevron_right</span>
                    <a :href="route('aplicacion.infoProductos', { aplicacion, rol })" class="hover:text-essentials-secundary">
                        <p>Gestion de mis productos</p>
                    </a>
                    <span class="material-symbols-rounded text-[18px]">chevron_right</span>
                    <p class="font-bold">Crear nuevos productos</p>
                </div>
